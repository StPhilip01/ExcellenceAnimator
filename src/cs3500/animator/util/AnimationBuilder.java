...
/**
 * Represents functionality to create a document with shapes, motions, keyframes, and set bound
 * parameters.
 *
 * @param <Doc> type of document to create
 */
public interface AnimationBuilder<Doc> {
  ...
  AnimationBuilder<Doc> addMotion(String name,
      ...
      int t2, int x2, int y2, int w2, int h2, int r2, int g2, int b2, int rotation1, int rotation2);
