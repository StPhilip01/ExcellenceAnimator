...
/**
 * Represents unit tests for the {@link ActionImpl} implementation of {@link Action}.
 */
public class ActionImplTest {
  ...
  public void init() {
    ...
    defaultAction = new ActionImpl("R", rect, 1, 10, rect.getCurrentPosition(), rect.getWidth(),
        rect.getHeight(), rect.getColor());

    ellipse = new Ellipse(20, 20, new Position(0, 0), new RGBColor(255, 255, 255), false);
    growEllipse = new ActionImpl("C", ellipse, 10, 50, ellipse.getCurrentPosition(),
        120, 220, ellipse.getColor());

    shrinkEllipse = new ActionImpl("shrunk", ellipse, 10, 40, ellipse.getCurrentPosition(),
        20, 30.4, ellipse.getColor());
  }

  @Test(expected = IllegalArgumentException.class)
  public void constructorNullShape() {
    Action a = new ActionImpl("R", null, 1, 10, rect.getCurrentPosition(), rect.getWidth(),
        rect.getHeight(), rect.getColor());
  }

  @Test(expected = IllegalArgumentException.class)
  public void constructorNullPosition() {
    Action a = new ActionImpl("R", rect, 1, 10, null, rect.getWidth(),
        rect.getHeight(), rect.getColor());
  }

  @Test(expected = IllegalArgumentException.class)
  public void constructorNullColor() {
    Action a = new ActionImpl("R", rect, 1, 10, rect.getCurrentPosition(), rect.getWidth(),
        rect.getHeight(), null);
  }

  @Test(expected = IllegalArgumentException.class)
  public void constructorNullShapeName() {
    Action a = new ActionImpl(null, rect, 1, 10, rect.getCurrentPosition(), rect.getWidth(),
        rect.getHeight(), rect.getColor());
  }

  @Test(expected = IllegalArgumentException.class)
  public void constructorNegativeFirstTick() {
    Action a = new ActionImpl("shape", rect, -1, 10, rect.getCurrentPosition(), rect.getWidth(),
        rect.getHeight(), rect.getColor());
  }

  @Test(expected = IllegalArgumentException.class)
  public void constructorNegativeFinalTick() {
    Action a = new ActionImpl("shape", rect, 1, -1, rect.getCurrentPosition(), rect.getWidth(),
        rect.getHeight(), rect.getColor());
  }

  @Test(expected = IllegalArgumentException.class)
  public void constructorNegativeBothTicks() {
    Action a = new ActionImpl("shape", rect, -10, -1, rect.getCurrentPosition(), rect.getWidth(),
        rect.getHeight(), rect.getColor());
  }

  @Test(expected = IllegalArgumentException.class)
  public void constructorFinalTickLessThanFirst() {
    Action a = new ActionImpl("shape", rect, 100, 1, rect.getCurrentPosition(), rect.getWidth(),
        rect.getHeight(), rect.getColor());
  }
  ...
  public void testExecuteGrowEllipse() {
    ...
    assertEquals(120, ellipse.getWidth(), .0001);
    assertEquals(220, ellipse.getHeight(), .0001);
  ...
  public void testExecuteShrinkEllipse() {
    ...
    assertEquals(20, ellipse.getWidth(), .0001);
    assertEquals(30.4, ellipse.getHeight(), .0001);
    assertTrue(ellipse.getVisibility());
    assertEquals(new Position(0, 0), ellipse.getCurrentPosition());
    assertEquals(new RGBColor(255, 255, 255), ellipse.getColor());
  }
  ...
  public void testGetFirstTick() {
    ...
    assertEquals(10, shrinkEllipse.getFirstTick());
  ...
  public void testGetFinalTick() {
    assertEquals(10, defaultAction.getFinalTick());
    assertEquals(40, shrinkEllipse.getFinalTick());
    assertEquals(50, growEllipse.getFinalTick());
  }
  ...
  public void testTickExecute() {
    Action a = new ActionImpl("r", rect, 1, 10, new Position(10, 10), rect.getWidth(),
        rect.getHeight(), rect.getColor());
    a.tickExecute(9);
    assertEquals(new Position(8.88888, 8.88888), rect.getCurrentPosition());

    // add 4 to the rectangle's height in 4 ticks. (1 unit per tick)
    // after 2 ticks, it should go from 100 to 102
    Action a2 = new ActionImpl("r", rect, 8, 12, rect.getCurrentPosition(), rect.getWidth(),
        rect.getHeight() + 4, rect.getColor());
    a2.tickExecute(10);
    assertEquals(102, rect.getHeight(), .0001);
  }
